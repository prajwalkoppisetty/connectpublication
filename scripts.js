...
const allContainers = document.querySelectorAll(
  '.applyingboxes .flex-card, .custom-container1, .custom-container2, .custom-container3'
);
...
const eventlisten = document.querySelectorAll(".choosebutton");

eventlisten.forEach(button => {
  button.addEventListener("click", () => {
    window.location.href="https://www.instagram.com/connect_publications_pvt_ltd/";
  });
});
